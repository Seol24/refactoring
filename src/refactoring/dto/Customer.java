...
public class Customer {
   ...
   public String statement(){
      ...
      for(Rental each : rentals){
         double thisAmount = 0;
         // 비디오물당 대여료
         //1. 일반물 (2일) 2000원, 일일초과 1500원, 적립1 ==>(2일, 3000원) 일일 초과 2000, 적립1
         //2. 아동물 (3일) 1500원, 일일초과 1500원, 적립1 ==>(2일, 2000원) 일일 초과 1500, 적립1
         //3. 최신물 (1일) 3000원, 일일초과 3000원, 적립1 + 1 ==>(2일, 4000원) 일일 초과 4000, 적립 1+1
         //HTml형식을 출력 원함.
   ...
   public String htmlstatement(){
	      ...
	      int frequentRenterPoints = 0;//적립포인트
	      StringBuilder sb = new StringBuilder();
	      sb.append("<h1><Em>getName()+"+getName()+"고객님의 대여기록\n</Em></h1><br>");
